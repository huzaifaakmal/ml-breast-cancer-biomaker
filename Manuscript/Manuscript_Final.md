...
**Huzaifa Akmal$^{1}$**, **[Supervisor Name]$^{1,*}$**

$^{1}$ *Sanata Dharma University*
$^{*}$ *Corresponding author: [Supervisor Email]*
...
> File: Figure_9_Decision_Curve_Analysis.jpeg
---
---
> **[INSERT FIGURE 10 HERE]**
> File: Figure_10_Calibration_Curve.jpeg
---
...
> File: Figure_11_SHAP_Summary_Plot.jpeg
---
...
Crucially, the signature serves as a surrogate for the tumor immune microenvironment. High retention correlates with cytotoxic CD8+ T cell infiltration, whereas signature loss signals M2 macrophage-mediated immunosuppression (Denkert et al., 2018). This immunological connection, clarified in recent 2023-2024 studies (Zhang et al., 2024b; Al-Zoughbi et al., 2024; Li et al., 2024; Huang et4, 2024), suggests utility in immunotherapy stratification. Compared to costly assays like Oncotype DX (CMS, 2024), our panel provides a parsimonious, cost-effective alternative suitable for decentralized RT-qPCR implementation.
...
Qin, G., et4, al. (2024). Role of four and a half LIM domain protein 1 in tumors. *Oncology Letters*, 28(4), 473. 
...
Xu, Y., et al. (2013). FHL1 interacts with oestrogen receptors and regulates BC cell growth. *JCMM*, 17(11), 1497–1497.
